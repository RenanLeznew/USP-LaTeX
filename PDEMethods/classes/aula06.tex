...
\begin{exr}
	Generalize a definição de A utilizando uma malha \(m\times n\) para discretizar o domínio \(\Omega \), e utilize o \hyperlink{kronecker_matrix}{\textit{produto matricial de Kronecker}} para construir a matriz A (no MATLAB, é o comando \texttt{kron}). Uma dica é que a forma final será
	\[
