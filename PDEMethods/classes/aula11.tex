...
\begin{example}[Estabilidade do Método de Euler Implícito]
	\textbf{\underline{ATENÇÃO:}} a notação vetorial pode ser indicada por um \(\underline{vetor}\) \textit{underline}!
...
\begin{example}[Alguns Métodos de Runge-Kutta]
	...
	\begin{listing}[H]
		...
		\begin{minted}[bgcolor = DarkBackground, linenos=true, breaklines]{Matlab}
 function fd = f_pp ( u)
