...
\begin{itemize}
	...
	\item[Provinha 2)] 11/06/2026 (peso 0.5)
	\item[Prova 2)] 30/06/2026 (peso 3)
\end{itemize}

Ao todo, a nota final é calculada por
\[
	\text{Média Final} =  \frac{0.5\mathrm{Pr}_{1}}{6} + \frac{2 \mathrm{P}_{1}}{6} +\frac{0.5\mathrm{Pr}_{2}}{6}+\frac{3 \mathrm{P}_{2}}{6}.
\]
\newpage
