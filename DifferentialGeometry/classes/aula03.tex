...
\begin{example}[Círculo]
	...
	de modo que
	\[
		t(s)=\alpha '(s) = \biggl(\cos^{}{\biggl(\frac{s}{r}\biggr)}, \sin^{}{\biggl(\frac{s}{r}\biggr)}\biggr)
	\]
	é unitário, ou seja, \(\alpha \) é parametrizada p.c.a. Neste caso, como
	\[
		t'(s)=\biggl(-\frac{1}{r} \sin^{}{\biggl(\frac{s}{r}\biggr)}, \frac{1}{r}\cos^{}{\biggl(\frac{s}{r}\biggr)}\biggr) = \frac{1}{r}n(s),
	\]
