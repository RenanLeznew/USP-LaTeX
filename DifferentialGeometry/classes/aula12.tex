...
\begin{def*}
	...
	tal que
	\[
		\mathrm{d}f_{p}(\underline{x}_{u}(q)) = \frac{\partial^{}}{\partial u^{}}(f\circ \underline{x})(q) \quad\&\quad \mathrm{d}f_{p}(\underline{x}_{v}(q)) = \frac{\partial^{}}{\partial v^{}}(f\circ \underline{x})(q),
	\]
...
Temos também
\[
	\mathrm{d}N_{p}(\underline{x}_{u}) =N_{u}\in T_{p}S \quad\&\quad N_{p}(\underline{x}_{v}) = N_{v}\in T_{p}S,
\]
tal que, derivando a identidade \(\langle N, \underline{x}_{U} \rangle = 0\) e \(\langle N, \underline{x}_{v} \rangle = 0\), obtemos
\[
	\left\{\begin{array}{ll}
		\langle N_{v}, \underline{x}_{u} \rangle + \langle N, \underline{x}_{uv} \rangle = 0 \\
		\langle N_{u}, \underline{x}_{v} \rangle + \langle N, \underline{x}_{u, v} \rangle = 0
	\end{array}\right. \Rightarrow \langle N_{v}, \underline{x}_{u} \rangle = \langle N_{u}, \underline{x}_{v} \rangle,
\]
concluindo que
\[
	\langle \mathrm{d}N_{p}(\underline{x}_{u}) , \underline{x}_{v} \rangle = \langle \underline{x}_{u}, \mathrm{d}N_{p}(\underline{x}_{v}) \rangle.
\]
Daí, para vetores \(w_{1} = a_{1}\underline{x}_{u} + b_{1}\underline{x}_{v}\) e \(w_{2} = a_{2}\underline{x}_{u}+b_{2}\underline{x}_v\) em \(T_{p}S,\) temos
\begin{align*}
	\langle \mathrm{d}N_{p}(w_{1}), w_{2} \rangle & = \langle a_1 \mathrm{d}N_{p}(\underline{x}_{u})+b_1 \mathrm{d}N_{p}(\underline{x}_{v}), a_{2}\underline{x}_{u}+b_{2}\underline{x}_{v} \rangle                                                                                   \\
	                                              & = a_1a_2\langle \mathrm{d}N_{p}(\underline{x}_{v}), \underline{x}_{u} \rangle + b_1b_2\langle \mathrm{d}N_{p}(\underline{x}_{v}), \underline{x}_{v} \rangle                                                                      \\
	                                              & = a_1a_2\langle \underline{x}_{u}, \mathrm{d}N_{p}(\underline{x}_{u}) \rangle + a_1b_2\langle \underline{x}_u, \mathrm{d}N_{p}(\underline{x}_v) \rangle + a_2b_1 \langle \underline{x}_v, \mathrm{d}N_p(\underline{x}_v) \rangle \\
	                                              & \quad + b_1b_2\langle \underline{x}_v, \mathrm{d}N_p(\underline{x}_v) \rangle                                                                                                                                                    \\
	                                              & = \langle a_1\underline{x}_u, \mathrm{d}N_p(a_2\underline{x}_u + b_2\underline{x}_v) \rangle                                                                                                                                     \\
	                                              & = \langle w_1, \mathrm{d}N_p(w_2) \rangle,
\end{align*}
ou seja, \(\mathrm{d}N_p :T_pS\rightarrow T_pS\) é o seu próprio adjunto, um \textbf{operador autoadjunto}.
\begin{tcolorbox}[
		skin=enhanced,
		title=Lembrete!,
		after title={\hfill Operador autoadjunto},
		fonttitle=\bfseries,
	...
	Um operador \(A:X\rightarrow X\) é dito \textbf{autoadjunto} se
	\[
		\langle Ax, y \rangle = \langle x, Ay \rangle.
	\]
	O motivo é que, em contextos normais, o \textbf{adjunto de A} é um operador \(A^{*}:X\rightarrow X\) que satisfaz
	\[
		\langle Ax, y \rangle = \langle x, A^{*}y \rangle, \quad \forall x, y\in X.
	\]
	Algumas formalidades foram cortadas aqui!
\end{tcolorbox}
\end{document}
