...
\end{quote}
claro, pode ser que algum dos termos acima sejam estranhos à formalização matemática por agora, mas temos pelo menos uma noção intuitiva do que cada coisa quer dizer, então já temos uma apreciação inicial sobre a potência desse resultado.
...
Observe que, para a esfera \(\mathbb{S}^{2}(r)\) de raio r, temos
\begin{align*}
...
\begin{itemize}
	...
	\item Procurar propriedades intrínsecas de superfícies, permitindo-nos diferenciá-las.
\end{itemize}
