...
Uma propriedade muito interessante dos círculos osculadores é que o raio deles é exatamente \(1/\kappa (s_{0})\), ou seja, ganhamos outra definição da curvatura de uma curva plana: a curvatura de \(\alpha \) é o inverso do raio do círculo que tem contato maior ou igual a 3 com ela.
...
\begin{exr}
	Encontre uma parametrização da evoluta da elipse parametrizada por \(\alpha (u)=(a \cos^{}{u}, b \sin^{}{u})\), com \(u\in \mathbb{R}\) e \(0<b<a\)
\end{exr}
