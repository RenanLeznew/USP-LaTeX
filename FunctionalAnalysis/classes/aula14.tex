...
\begin{proof*}
	...
	\[
		\langle (-Ax, x), (x^{*}, y^{*}) \rangle=-\langle Ax, x^{*} \rangle + \langle x, y^{*} \rangle =0
	\]
...
\begin{proof*}
	...
	\end{align*}
	Portanto, \(\{x_{n}^{*}\}\) tem subsequência convergente para algum \(x^{*}\in X^{*}\), provando (b). \qedsymbol
\end{proof*}
\begin{tcolorbox}[
		skin=enhanced,
		title=Lembrete!,
		after title={\hfill Arzelá-Ascoli},
		fonttitle=\bfseries,
		sharp corners=downhill,
		colframe=black,
		colbacktitle=yellow!75!white,
	...
	O \hypertarget{arzela_ascoli}{Teorema de Arzelá-Ascoli} pode ser enunciado como
	\begin{theorem*}
