...
\begin{tcolorbox}[
	...
	Podem haver (e, em geral, há) sequências que convergem fracamente em um espaço de dimensão infinita, mas não convergem fortemente; a exemplo, se \(X^{*}\) é separável e X é reflexivo, sempre pode-se construir uma sequência \(\{x_{n}\}\) fracamente convergente para zero com \(\Vert x \Vert=1\).

	No entanto, há espaços de dimensão infinita conde toda sequência fracamente convergente é sim convergente, tal como o espaço \(X=\ell^{1}\).
\end{tcolorbox}
