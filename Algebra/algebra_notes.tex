 ...
 \usepackage{tikz-cd}
\usepackage{etoolbox}
\usepackage{currfile} % gives \currfilename

\newwrite\deflog

\AtBeginDocument{%
	\immediate\openout\deflog=\jobname.deflist
}

\AtEndDocument{%
	\immediate\closeout\deflog
}

\AtBeginEnvironment{def*}{%
	\immediate\write\deflog{DEF in \currfilename\space on page \thepage}%
}
