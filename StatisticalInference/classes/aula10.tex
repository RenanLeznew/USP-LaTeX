...
Antes de aprofundarmos no desenvolvimento estatístico das ideias de Pearson, vamos estar dando uma olhada no seu desenvolvimento científico, pois ele trabalhou bastante na física dos fluídos e na dinâmica do Éter, concluindo que duas esferas imersas em um fluído incompressível, e que pulsa (muda de volume) de forma regular, exercem um no outro uma atração (pela mediação do fluído), determinada pela lei dos quadrados inversos, caso as pulsações sejam concordantes, e (similarmente) exercem repulsão se as fases de pulsações diferem por meio período.
