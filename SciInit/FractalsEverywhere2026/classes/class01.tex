...
\begin{exr}
	...
	Since the fraction \(\displaystyle \frac{n}{n^{2}+1}\) is decreasing, for increasing n's, it eventually converges to 3. The closest point to x will be \(5/2\), the case n=1, since the following ones will be either too much to the left or too much to the right, it follows that
	\[
