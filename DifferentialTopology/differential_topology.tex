...
\begin{center}
	...
	\vspace{1.3cm}
	\large
	\textbf{Professor(a): Carlos Alberto Maquera Apaza}

	\textbf{E-mail: cmaquera@icmc.usp.br}
...
\begin{thebibliography}{99}
	\bibitem{milou} J. Milou. \textbf{Topology from the Differential View}
	\bibitem{guillemin} V. Guillemin; Pollock. \textbf{Differential Topology}
	\bibitem{matsumoto} Matsumoto. \textbf{An Introduction to Morse Theory}
\end{thebibliography}
