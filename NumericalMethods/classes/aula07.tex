...
\end{minted}
\end{listing}
Tendo o motor cripto montado, temos que montar o script principal, nomeado \textbf{app espião} (🤫🫢); para tanto, basta fazer

\begin{listing}[H]
	\begin{minted}[bgcolor = DarkBackground, linenos=true, breakline]{Python}
 # ============================== 
 # NASCE UM ESPIÃO
 # ============================== 
 ...
 # 1. As chaves matemáticas 
  ...
  for linha in matriz_C: 
      print(linha)
  print(f"☢️ TEXTO INTERCEPTADO NA REDE: '{mensagem_hacker}'\n")
