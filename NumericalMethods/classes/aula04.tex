...
\begin{listing}
 ...
 \end{minted}
  ...
  array_cont = np.arange(10) # array com elementos de 0 a 9
...
for linha in range(array_bidim.shape[0]): # numero linhas
    for coluna in range(array_bidim.shape[1]): # numero colunas
        print('Elemento', linha, ' ', coluna, ' = ', array_bidim[i, j])
\end{minted}
\end{listing}
...
np.savetext('exemplo_escrita.txt', array, fmt = '%d')
